...
public class SDEOSIntegrationTests {
	...
	public void testHasClassInstances() throws IOException {
		...
		IClass clazz = p.parse("java.util.Collections", model);
	...
	public void testHasMethodCallsDepth5() throws IOException {
		IModel model = new Model();
		String[] clazzes = new String[] { "testClasses.TestClass", "testClasses.TestClassTwo",
				"testClasses.TestClassThree" };
		for (String s : clazzes) {
			IClass clazz = p.parse(s, model);
			model.addClass(clazz);
		}
